...
def main():
    ...
    FailIfNot(test.TestFailsafe(nodeid=1, threadOperationalDataset=TEST_THREAD_NETWORK_DATASET_TLV, setuppin=20202021, ip=options.deviceAddress), "Failed failsafe test")
