...
#define EMBER_AF_DISCO_BALL_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Disco Ball cluster is included
#define ZCL_USING_DISCO_BALL_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_DISCO_BALL_SERVER
#define EMBER_AF_PLUGIN_DISCO_BALL
